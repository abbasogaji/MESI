...
public class ParalelismoT2EII {
    ...
    public static void main(String[] args)  throws IOException {
        ...
        System.out.println("El tamano de la cache del nivel 1 es: " + tamcacheL1 + " bits");
        System.out.println("El tamano de la cache del nivel 2 es: " + tamcacheL2 + " bits");
        System.out.println("El tamano del bloque para ambos niveles es: " + tambloq + " bits");
		...
		//if((contadorp1+contadorp2)%2==0){ //El contador es par, trabaja el procesador a
			...
			if(tagL1dato.equals(aux2)){//el dato está en L1b
                ...
                if((contadorp1)>=(datos1+datos2-25)){
                    ...
                    System.out.println("La direcciothe 25n en binario del dato es: " + direcbin);
                    System.out.println("La accion es: " + accion);
                    //if(contadorp1%2==0){
                //    System.out.println("trabaja Pa");
